...
-- jj to get out of insert mode (for normie keyboards, particularly laptop)
vim.keymap.set('i', 'jj', '<Esc>', { silent = true, desc = 'Switch from I to Normal Mode' })



-----------------------------------------------------------
--- Helix Inspired Changes
-----------------------------------------------------------
...
--vim.keymap.set('n', '<C-k>', vim.lsp.buf.signature_help, { desc = 'Signature Help' }) (Conflict)
...
--- NeoTree
-----------------------------------------------------------
vim.keymap.set('n', '<leader>t', ':Neotree toggle=true source=filesystem<CR>',
    { noremap = true, desc = 'Toggle file tree' })
vim.keymap.set('n', '<leader>g', ':Neotree toggle=true source=git_status<CR>',
    { noremap = true, desc = 'Toggle file tree' })
vim.keymap.set('n', '<leader>b', ':Neotree toggle=true source=buffers<CR>',
    { noremap = true, desc = 'Toggle file tree' })
vim.keymap.set('n', '<leader>y', ':Neotree toggle=true source=document_symbols<CR>',
    { noremap = true, desc = 'Toggle file tree' })
...
vim.keymap.set('n', '<leader>E', function() require("telescope.builtin").resume() end,
    { desc = 'Search Resume' })
...
-----------------------------------------------------------
vim.keymap.set('n', '<leader>p', function() require("goto-preview").goto_preview_definition({}) end,
